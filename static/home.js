...
function appendBotMessage(message, botMessageId, chatMessages) {
    ...
    messageContentContainer.classList.add('mb-4', 'flex', 'rounded-xl', 'bg-slate-50', 'px-2', 'py-6', 'sm:px-4', 'light-theme-only'); // Added 'light-theme-only' class
...
function prependBotMessage(message, botMessageId, chatMessages) {
    const botMessageContainer = document.createElement('div');
    botMessageContainer.id = botMessageId;
    botMessageContainer.classList.add('mb-4', 'flex', 'rounded-xl', 'bg-slate-50', 'px-2', 'py-6', 'sm:px-4', 'chat-message', 'light-theme-only'); // Added 'light-theme-only' class
...
function showLoadingWidget(chatMessages) {
    ...
    loadingWidget.innerHTML = `
        <div role="status" class="light-theme">
